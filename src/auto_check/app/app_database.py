...
EXPECTED_APP_SCHEMA: Mapping[str, frozenset[str]] = MappingProxyType(
    {
        ...
        "db_validation_mapping_snapshots": _columns(
            "id",
            "signature_json",
            "refresh_source",
            "status",
        ...
        "db_validation_mapping_tables": _columns(
            "id",
            "snapshot_id",
            "relation_type",
            "logical_code",
        ...
        "db_validation_mapping_fields": _columns(
            "id",
            "snapshot_id",
            "table_mapping_id",
            "chinese_name",
            "automatic_field_name",
            "override_field_name",
        ...
        "db_validation_cross_table_mappings": _columns(
            "id",
            "mapping_code",
            "logical_code",
            "scope_code",
            "automatic_detail_field_name",
            "override_detail_field_name",
            "effective_detail_field_name",
            "automatic_template_table_name",
            "override_template_table_name",
            "effective_template_table_name",
            "automatic_template_field_name",
            "override_template_field_name",
            "effective_template_field_name",
            "mapping_status",
            "status_message",
            "is_seed",
            "refreshed_at",
        ...
        "db_validation_mapping_overrides": _columns(
            "id",
            "mapping_kind",
            "relation_type",
            "logical_code",
        ...
        "db_validation_mapping_audit_logs": _columns(
            "id",
            "override_id",
            "action_code",
            "mapping_kind",
        ...
        "report_nav_card_manual_history": _columns(
            "stat_period",
            "period_key",
            "card_code",
            "completed_count",
        ...
        "report_nav_work_calendar": _columns(
            "calendar_date",
            "calendar_year",
            "day_type",
            "day_name",
