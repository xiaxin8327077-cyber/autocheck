...
function copyDraft(region, { forceIdle = false, revision = 1 } = {}) {
  ...
  return { region_id: region.id, row_version: source.row_version || 1, source_mode: source.source_mode || region.default_mode || "sql", datasource_id: source.datasource_id || "", sql_text: source.sql_text || "", testStatus: !forceIdle && source.tested_signature ? "passed" : "idle", preview: null, revision };
}
